...
class TransUNetTrainer(nnUNetTrainer):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.num_outputs = 1 # For deep supervision
        self.pin_memory = True
        # self.use_progress_bar = True
        self.do_elastic = False
    ...
    def process_plans(self, plans):
        ...
        self.plans = plans
        self.num_batches_per_epoch = plans["num_train_batches_per_epoch"]
        self.num_val_batches_per_epoch = plans["num_val_batches_per_epoch"]

        # Deep supervision
        self.num_outputs = len(plans['plans_per_stage'][0]["config"]["decoder_channels"])
        self.deep_supervision_scales = [[1/2**(self.num_outputs - 1 - i)]*3 for i in range(self.num_outputs)]
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if not self.was_initialized:
            ...
            weights = np.array([1/2**(self.num_outputs - 1 - i) for i in range(self.num_outputs)])
