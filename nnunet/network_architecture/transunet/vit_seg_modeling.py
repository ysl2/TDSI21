...
class DecoderCup(nn.Module):
    ...
    def forward(self, hidden_states, features=None, do_ds=False):
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False, do_ds=False):
        super(VisionTransformer, self).__init__()
        self.img_size = config.img_size if config.get("img_size") is not None else img_size
